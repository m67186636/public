...
Senior .NET developer, with over ten years of experience, specializing in C# backend development, distributed system architecture, big data collection and retrieval, IoT, AI applications, device orchestration, and 3D content delivery. Led multiple provincial key projects and data platforms with millions of records, highly skilled in complex system design and end-to-end delivery.

---

## Strengths & Core Skills

- **Deep .NET Practice**: Expert in .NET 6/7/8/9/10, ABP framework, EF Core; led microservice architectures, modularized applications, and permission system design.
...
- **Industrial-Grade Device Orchestration**: Architect for large exhibition halls and multi-device control, including clock synchronization, TCP/IP and serial communications, precise device orchestration, and disaster recovery.
- **Artificial Intelligence & NLP Application**: Integrated dify, Ollama LLMs for smart response in unattended live streaming, content generation, semantic parsing of bullet comments, and scenario AI.
- **Frontend & Cross-platform Development**: Specialized in JavaScript/TypeScript, THREE.JS for 3D scene rendering, efficient multi-end adaptation via UNI-APP (WeChat/Alipay/Douyin Mini Program support).
...
- **Testing & DevOps**: Selenium WebDriver, GitHub Actions/Azure DevOps, Docker/K8s, ensuring quality delivery in automation pipelines.

---

## Tech Stack

- **Backend/Distributed**: C#/.NET 6+, ABP, Dapr, Quartz.NET, EF Core, SignalR
- **Big Data/AI**: MongoDB, Elasticsearch, Common Crawl, dify, Ollama, ML.NET
- **Frontend/Cross-platform**: JavaScript, TypeScript, HTML5, CSS3, Ant Design Vue, Element UI, ECharts/Chart.js, THREE.JS, UNI-APP
- **IoT/Embedded**: Arduino, ESP32, TCP/IP, Serial comm, Clock sync
- **Testing/DevOps**: Selenium WebDriver, GitHub Actions, Azure DevOps, Docker, Kubernetes
- **Other**: Shell, RESTful API, JWT, OAuth2.0, Agile development
...
- Built scalable .NET backend architecture; distributed scheduling, Common Crawl WARC batch processing, automated text/structure/meta extraction.
- MongoDB sharded clusters + full-text index, sub-second query for hundreds of GB of data.
...
[Global-sites project repo](https://github.com/m67186636/Global-sites)
...
- Real-time log analytics using Elasticsearch.
...
- Unified API for mobile, web, mini program; automated pipeline, permission management, message pushes, third-party payment integration.

[beauty project repo](https://github.com/m67186636/beauty)
...
- Integrated dify (AI knowledge base, QA bot) and Ollama (local LLM inference), enabling smart bullet chat response, automatic content generation, and script planning.
- Multi-account multi-platform control, containerized high concurrency processing.

[mt project repo](https://github.com/m67186636/mt)
...
- ABP-based modular microservices, multitenancy and permission management.
- Frontend decoupled (Blazor/Vue), Docker-based automated testing and deployment.

[Vision project repo](https://github.com/m67186636/Vision)
...
- Modular domain-driven design, multi-DB support, authentication, permission management and multi-tenancy.
- Complex frontend with Vue/Blazor, supporting multiple business verticals.

---

### Selenium WebDriver Automated Testing Platform

- End-to-end UI testing, Allure reporting, CI/CD integration for efficient automated acceptance.
...
- **Foundational C# with Microsoft**  
  ...
  Certificate ID: m67186636-fcswm  
  ![image1](image1)
...
- Multi-domain hands-on experience: big data, IoT, AI, exhibition device orchestration, robotics, 3D/mini program implementation
...
- 11+ public GitHub repositories: big data, AI, IoT, 3D, automation, mini programs and more
...
> For more projects and details, visit my GitHub profile [m67186636](https://github.com/m67186636). For project highlights or resume customization, please get in touch!
